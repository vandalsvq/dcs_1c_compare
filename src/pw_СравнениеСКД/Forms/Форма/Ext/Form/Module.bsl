...
Процедура ВыполнитьСравнениеНаСервере()
	ОбъектСхема = ЭтотОбъект.РеквизитФормыВЗначение("Схема1");
	ОбъектСхема.Загрузить();
	ЭтотОбъект.ЗначениеВРеквизитФормы(ОбъектСхема, "Схема1");
	
	ОбъектСхема = ЭтотОбъект.РеквизитФормыВЗначение("Схема2");
	ОбъектСхема.Загрузить();
	ЭтотОбъект.ЗначениеВРеквизитФормы(ОбъектСхема, "Схема2");
